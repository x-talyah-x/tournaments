...
// Paystack Public Key
const PAYSTACK_PUBLIC_KEY = "pk_test_17655c4677eb0a914b9bf7557869ac2749f81744";
...
async function handleSignup(e, tournamentId, isDoubles) {
  ...
  const entryFee = tournament ? (tournament.entry_fee || 0) : 0;
...
async function completeRegistration({ tournamentId, profileId, partnerName, paymentStatus, paymentMethod, reference, amount = 0 }) {
